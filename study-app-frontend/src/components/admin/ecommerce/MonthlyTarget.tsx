...
export default function StudentPaperProgressChart() {
  const series = [75]; // % of papers completed
  const options: ApexOptions = {
    colors: ["#465FFF"],
    chart: { type: "radialBar", height: 330, sparkline: { enabled: true }, fontFamily: "Poppins, sans-serif" },
    plotOptions: {
      radialBar: {
        startAngle: -85,
        endAngle: 85,
    ...
    <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]">
      <div className="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6">
        <div className="flex justify-between">
          <div>
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white/90">
              Student Paper Completion
            </h3>
            <p className="mt-1 font-normal text-gray-500 text-theme-sm dark:text-gray-400">
              Percentage of assigned papers completed this month
            </p>
          </div>
        ...
        <p className="mx-auto mt-10 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base">
          Papers completed are higher than last month. Keep up the good work!
        </p>
      </div>
      ...
      <div className="flex items-center justify-center gap-5 px-6 py-3.5 sm:gap-8 sm:py-5">
        <div>
          <p className="mb-1 text-center text-gray-500 text-theme-xs dark:text-gray-400 sm:text-sm">Monthly Target</p>
