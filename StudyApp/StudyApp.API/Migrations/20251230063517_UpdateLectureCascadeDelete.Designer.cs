...
namespace StudyApp.API.Migrations
{
    ...
    [Migration("20251230063517_UpdateLectureCascadeDelete")]
    partial class UpdateLectureCascadeDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudyApp.API.Domain.Entities.Blogs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudyApp.API.Domain.Entities.LiveClass", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("StudyApp.API.Domain.Entities.StudentLecture", b =>
                {
                    ...
                    b.HasIndex("SessionId", "LecturedetailId")
                        .IsUnique();
            ...
            modelBuilder.Entity("StudyApp.API.Domain.Entities.StudentLecture", b =>
                {
                    b.HasOne("StudyApp.API.Domain.Entities.ApplicationUser", null)
